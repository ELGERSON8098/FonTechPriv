...
const fillTable = async (form = null) => {
    ...
    if (DATA.status) {
        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    <td><img src="${SERVER_URL}images/marcas/${row.imagen}" height="50"></td>
                    <td>${row.marca}</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    ...
                    <td></td>
                    <td>
                        <button type="button" class="btn btn-info rounded me-2 mb-2 mb-sm-2" onclick="openUpdate(${row.id_marca})">
                            <i class="bi bi-pencil-fill"></i>
                        </button>
                        <button type="button" class="btn btn-danger rounded me-2 mb-2 mb-sm-2" onclick="openDelete(${row.id_marca})">
