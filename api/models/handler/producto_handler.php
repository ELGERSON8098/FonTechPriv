...
class productoHandler
{
    ...
    {
        $sql = 'SELECT p.id_producto, p.imagen, p.nombre_producto, p.descripcion_producto, p.precio_producto, p.existencias_producto
                FROM tb_productos p
                INNER JOIN tb_categorias c ON p.id_categoria = c.id_categoria
                WHERE p.id_categoria = ? AND p.estado_producto = true
                ORDER BY p.nombre_producto';
